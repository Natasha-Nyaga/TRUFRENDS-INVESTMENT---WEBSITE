            ...
            <div className="main">
                <div className="row">
                    <div className="col-md-6">
                        <div className="card">
                          <img src="/src/assets/images/property-development-icon.png" alt="an image icon for property development and sale" className="image-icon"/>
                    ...
                    <div className="col-md-6">
                        <div className="card">
                          <img src="/src/assets/images/business-solutions-icon.png" alt="an image icon for business solutions" className="image-icon"/>
                            <div className="main-text">
                    ...
                    <div className="col-md-6">
                        <div className="card">
                          <img src="/src/assets/images/short-term-rentals.png" alt="an image icon for short-term rentals for sale" className="image-icon"/>
                            <div className="main-text">
                    ...
                    <div className="col-md-6">
                        <div className="card">
                          <img src="/src/assets/images/supplies-procurement-icon.png" alt="an image icon for supplies and procurement" className="image-icon"/>
                            <div className="main-text">
